...
export const RANCH_ANIMALS = {
  ...
  chicken: {
    ...
    baseCost: 5000,
    unlockCriteria: { totalHarvested: 1000 },
  ...
  duck: {
    ...
    productionIntervalSecs: 30,
    baseCost: 18000,
    unlockCriteria: { totalHarvested: 5000 },
  ...
  turkey: {
    ...
    productionIntervalSecs: 30,
    baseCost: 130000,
    unlockCriteria: { totalHarvested: 40000 },
  ...
  pig: {
    ...
    productionIntervalSecs: 30,
    baseCost: 320000,
    unlockCriteria: { totalHarvested: 90000 },
  ...
  cattle: {
    ...
    productionIntervalSecs: 30,
    baseCost: 900000,
    unlockCriteria: { totalHarvested: 220000 },
